...
<div><h2 class="sub-header"><input type="button" value="{{ $txt['Show'] }}" class="ShowHide"><a href="#">{{ $txt['search_tool'] }}</a></h2></div>
...
<form method="get" id="search_form">
	...
	<div id="search_tool">
		...
		<ul class="search_block list-unstyled">
			...
			<li class="tool"><input type="text" name="date" @if(!empty($_GET['date'])) value="{{ $_GET['date'] }}" @endif></li>
		</ul>
		@endif
		...
		<ul class="search_block list-unstyled">
			...
			<li class="tool"><input type="text" name="account" @if(!empty($_GET['account'])) value="{{ $_GET['account'] }}" @endif></li>
		</ul>
		@endif
		...
		<ul class="search_block list-unstyled">
			...
			<li class="tool"><input type="text" name="real_name" @if(!empty($_GET['real_name'])) value="{{ $_GET['real_name'] }}" @endif></li>
		</ul>
		@endif
		...
		<ul class="search_block list-unstyled">
			<li class="item"><a href="#">{{ $txt['role_name'] }}</a></li>
			<li class="tool"><input type="text" name="role_name" @if(!empty($_GET['role_name'])) value="{{ $_GET['role_name'] }}" @endif></li>
		</ul>
		@endif
		...
		<ul class="search_block list-unstyled">
			...
			<li class="tool"><input type="text" name="service_name" @if(!empty($_GET['service_name'])) value="{{ $_GET['service_name'] }}" @endif></li>
		</ul>
		@endif
